...
RSpec.feature "Sign in", :type => :feature do
	...
	specify "page should have autorization actions" do
		expect(page).to have_css "a", text: "Sign up"
		expect(page).to have_css "a", text: "Sign in"
		expect(page).to_not have_css "a", text: "Dashboard"
	end
	...
	scenario "with valid fields" do
		...
		expect(page).to have_css "a", text: "Dashboard"
		expect(page).not_to have_css "a", text: "Sign up"
